...
public class Invoke_Stub_Test_A1EFACC110C27620CE27B63134633863 extends LTTestScript  {
...
private HTTPTestScriptHelper httpTestScriptHelper;
	...
	public Invoke_Stub_Test_A1EFACC110C27620CE27B63134633863(IContainer container, String invocationId) {
		super(container, "Invoke Stub", invocationId, "A1EFACC110C27620CE27B63134633863", "/Emirates/Invoke Stub.testsuite", "C:/Users/stuart.walker/HCL/devopstest/workspace/Emirates/Invoke Stub.testsuite");
		setArmEnabled(false);
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
		...
		loopNm_1.addVarsToInit(null);
			...
			this.httpTestScriptHelper.executeHelper();
		     ...
		     log("Test Execution: Invoke_Stub_Test_A1EFACC110C27620CE27B63134633863 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	parent.add(think);
		...
		HTTPPage page = new HTTPPage(parent, "SimpleService", "A1EFACC110FC71EACE27B63134633863") {
			...
			{ // Parallal Block Start
				...
				httpParallel.addRequest(0, request_1(this, true, "A1EFACC111012CD0CE27B63134633863", true, true,
						"localhost", "1",	"/", true, false), 0, 100, "null", 3);
			} // Parallal Block End 
